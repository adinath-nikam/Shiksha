          ...
          body: Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: StreamBuilder(
                      stream: FirebaseAPI().realtimeDBStream(
                          "SHIKSHA_APP/COLLEGE_TYPE"),
                      builder:
              ...
              children: [
                ...
                Expanded(
                  child: StreamBuilder(
                      stream: FirebaseAPI()
                          .realtimeDBStream(
                          "SHIKSHA_APP/COLLEGES/$selectedCollegeType"),
                      builder:
                          (BuildContext context,
                          AsyncSnapshot<DatabaseEvent> snapshot) {
                        if (!snapshot.hasData) {
...
class UserCategorySelectView extends StatelessWidget {
  ...
  const UserCategorySelectView({Key? key,
...
class StreamSelectView extends StatelessWidget {
  ...
  const StreamSelectView({Key? key,
    required this.selectedCollege,
    required this.isUpdate,
...
class SemesterSelectView extends StatelessWidget {
  ...
  const SemesterSelectView({Key? key,
    required this.selectedCollege,
                              ...
                              if (widget.isUpdate) {
                                try {
                                  ...
                                  signUpModelUserData = ModelUserData(
                                      ...
                                      userCollegeType: widget
                                          .selectedCollegeType);

                                  try {
                                    sharedPrefUserData
                                        .save(CONST_SP_USER_DATA,
                                        signUpModelUserData)
                                        .whenComplete(() {
                                  ...
                                  if (await allowSignUp()) {
                                    try {
                                      ...
                                      signUpModelUserData = ModelUserData(
                                          ...
                                          userSemester: widget.selectedSemester,
                                          userStream: widget.selectedStream,
                                          userEmail: controllerTextEditEmail
                                              .text
                                              .toString(),
                                          userPhone: controllerTextEditPhone
                                              .text
                                              .toString(),
                                          userJoiningDate:
                                      ...
                                      FirebaseAPI()
                                          .firebaseDatabase
                                          .ref(
                                          "SHIKSHA_APP/USERS_DATA/${signUpModelUserData
                                              .getUserUID}")
                                          .set({
                                        "user_id": signUpModelUserData
                                            .getUserUID,
                                        "last_active":
