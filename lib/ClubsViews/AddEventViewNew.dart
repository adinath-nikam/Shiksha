                        ...
                        children: [
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                              ...
                              prefixIcon: const Icon(MdiIcons.file),
                              contentPadding: const EdgeInsets.all(25.0),
                              border: const OutlineInputBorder(
                                borderSide: BorderSide.none,
                                borderRadius: BorderRadius.all(
                          ...
                          CustomButton(
                              ...
                              function: () {
                                if (addEventFormKey.currentState!.validate()) {
                                  ...
                                  modelEvent.eventPostedDate = DateTime.now().toString();
                                        ...
                                        builder: (BuildContext context) =>
                                            WillPopScope(
                                              ...
                                              child: CommonAlertDialog(
                                                  context, "Add Event Success!",
                                                  Icon(MdiIcons.calendarClockOutline, color: PrimaryDarkColor, size: 50,),
