...
class TCView extends StatelessWidget {
  const TCView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: CustomText(
            text: "Terms and Conditions", textSize: 18, color: PrimaryDarkColor),
          ...
          child: Container(
            child: Column(
              ...
              children: [
                ...
                CustomText(text: "This is Terms and Conditions Text.", textSize: 14, color: PrimaryDarkColor),
